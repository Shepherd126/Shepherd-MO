  ...
  void _onFilterStatusChanged(int? newValue) {
    if (newValue != null) {
      setState(() {
        ...
        _pagingController.refresh(); // Refresh the list when the filter changes
      });
    }
  }
                    ...
                    child: TextField(
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(Icons.search,
                            color:
                                isDark ? Colors.grey[400] : Color(0xFFEEC05C)),
                        filled: true,
                  ...
                  PopupMenuButton<int>(
                    onSelected: (value) {
                      setState(() {
                        _sortBy = value;
                        _pagingController
                            .refresh(); // Refresh list when sort option changes
                      });
                    },
                    itemBuilder: (context) => [
                      PopupMenuItem(
